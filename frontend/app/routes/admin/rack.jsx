...
export default function RackManager() {
  ...
  const [racks, setRacks] = useState(['f1', 'f2', 'f3', 'f4', 'f5']);
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-black/30">
      <h1 className="text-3xl text-white font-bold mb-6">Gestion des Produits</h1>

      <form onSubmit={handleSearch} className="space-y-4 p-6 bg-gray-400/20 rounded-md shadow-md">
